...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Gav's[/B][/COLOR]Wizard'
BUILDERNAME = 'OpenWizard'
EXCLUDES = [ADDON_ID, 'repository.gavswizard']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://raw.githubusercontent.com/toongav/repository.toongav/refs/heads/master/repo/plugin.program.gavswizard/builds.txt'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Gavs[/B][/COLOR]Wizard'
